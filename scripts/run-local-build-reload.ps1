# PowerShell script for running backend and frontend with build reload
# Handles proper process management and graceful shutdown on Ctrl+C

$ErrorActionPreference = "Stop"

Write-Host "Starting Traefik Dynamic Editor - Local Development with Build Reload" -ForegroundColor Green
...
try {
    ...
    Write-Host "[Frontend] Starting build:watch..." -ForegroundColor Cyan
